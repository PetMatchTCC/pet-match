            ...
            <>
              ...
              <div className="p-6 pt-20">
                <div className="flex justify-between items-start">
                  <div>
                    <h1 className="text-2xl font-bold text-gray-800">{userData?.username || "Nome não informado"}</h1>
                ...
                <div className="mt-6 flex gap-6 text-center">
                  <div>
                    <span className="block text-2xl font-bold text-orange-500">{userData?.petsPosted || 0}</span>
                    <span className="text-sm text-gray-500">Pets Postados</span>
                  </div>
                  <div>
                    <span className="block text-2xl font-bold text-orange-500">{userData?.followers || 0}</span>
                    <span className="text-sm text-gray-500">Seguidores</span>
                  </div>
                  <div>
                    <span className="block text-2xl font-bold text-orange-500">{userData?.likes || 0}</span>
